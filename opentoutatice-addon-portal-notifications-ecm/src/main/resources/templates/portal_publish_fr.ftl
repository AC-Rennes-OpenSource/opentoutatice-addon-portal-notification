                          ...
                          <tbody>
                            <tr>
                              ...
                              <td style="border:1px solid #eee;color:#000;font-size:13px;">
                                  <#if eventId == "documentPublished" || eventId == "documentPublicationApproved" || eventId == "workflowOnlineTaskApproved" | eventId == "documentSetOnLine">
                                  <a href="${docPermalink}" style="color:#22aee8;text-decoration:underline;word-wrap:break-word!important;">
                                  ${htmlEscape(docTitle)}</a>
                                  <#elseif eventId =="documentWaitingPublication" || eventId == "documentPublicationRejected" || eventId == "workflowOnlineTaskAssigned" || eventId == "workflowOnlineTaskRejected">
