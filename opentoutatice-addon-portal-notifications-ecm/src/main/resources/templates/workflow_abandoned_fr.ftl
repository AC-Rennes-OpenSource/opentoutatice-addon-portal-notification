                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        Le workflow sur le document <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docPermalink}">${htmlEscape(docTitle)}</a>
                        a été abandonné par ${workflowInitiator}:</p>
                        <p>vous n'avez plus de tâche sur ce document si vous en possédiez.</p><br/>
                     </td>
                    </tr>
                    <tr>
