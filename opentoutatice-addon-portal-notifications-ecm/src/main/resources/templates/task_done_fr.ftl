                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        ${nodeLastActor} a 
                        <#if eventId == "workflowTaskCompleted">
                          finalisé
                        <#elseif eventId == "workflowTaskRejected">
                          rejeté
                        </#if>
                        la tâche x sur le document <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docPermalink}">${htmlEscape(docTitle)}</a>.
                        </p><br/>
                     </td>
                    </tr>
                  </tbody>
