                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        Une tâche sur le document <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docPermalink}">${htmlEscape(docTitle)}</a> vous a été assignée.
